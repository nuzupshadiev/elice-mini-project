import {
  typescriptDefaults
} from "./chunk-W3YOV6IL.js";
import {
  editor_api_exports
} from "./chunk-R655FIAQ.js";
...
var Kind = (_a = class {
  ...
  _a.localVariable = "local var";
})(), (() => {
  _a.function = "function";
})(), (() => {
  _a.localFunction = "local function";
})(), (() => {
  _a.memberFunction = "method";
})(), (() => {
  _a.memberGetAccessor = "getter";
})(), (() => {
  _a.memberSetAccessor = "setter";
})(), (() => {
  _a.memberVariable = "property";
})(), (() => {
  _a.constructorImplementation = "constructor";
})(), (() => {
  _a.callSignature = "call";
})(), (() => {
  _a.indexSignature = "index";
})(), (() => {
  _a.constructSignature = "construct";
})(), (() => {
  _a.parameter = "parameter";
})(), (() => {
  _a.typeParameter = "type parameter";
})(), (() => {
  _a.primitiveType = "primitive type";
})(), (() => {
  _a.label = "label";
})(), (() => {
  _a.alias = "alias";
 ...
 *-----------------------------------------------------------------------------*/
//# sourceMappingURL=tsMode-TE3RCL3P.js.map
